...
types := normal fight flying poison ground rock bug ghost steel mystery fire water grass electric psychic ice dragon dark fairy light vaccine virus data free unknown
...
$(SLOTMACHINEGFXDIR)/reel_time_gfx.4bpp: $(SLOTMACHINEGFXDIR)/reel_time_petitmon.4bpp \
...
$(WALLPAPERGFXDIR)/toyagumon/tiles.4bpp: $(WALLPAPERGFXDIR)/friends_frame1.4bpp $(WALLPAPERGFXDIR)/toyagumon/bg.4bpp
	@cat $^ >$@
...
$(WALLPAPERGFXDIR)/jellymon/tiles.4bpp: $(WALLPAPERGFXDIR)/friends_frame2.4bpp $(WALLPAPERGFXDIR)/jellymon/bg.4bpp
	@cat $^ >$@

$(WALLPAPERGFXDIR)/petitmon/tiles.4bpp: $(WALLPAPERGFXDIR)/friends_frame2.4bpp $(WALLPAPERGFXDIR)/petitmon/bg.4bpp
	@cat $^ >$@
