...
#define BATTLE_TYPE_GATOMON_X_GROUDON     (1 << 12)
...
#define BATTLE_TYPE_RECORDED_INVALID        ((BATTLE_TYPE_LINK | BATTLE_TYPE_SAFARI | BATTLE_TYPE_FIRST_BATTLE                  \
                                             ...
                                             | BATTLE_TYPE_GATOMON_X_GROUDON | BATTLE_TYPE_LEGENDARY | BATTLE_TYPE_REGI            \
                                             | BATTLE_TYPE_RECORDED | BATTLE_TYPE_TRAINER_HILL | BATTLE_TYPE_SECRET_BASE        \
                                             | BATTLE_TYPE_GROUDON | BATTLE_TYPE_GATOMON_X | BATTLE_TYPE_RAYQUAZA))
