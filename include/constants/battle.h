...
#define BATTLE_TYPE_GATOMON_X_GEKOMON     (1 << 12)
...
#define BATTLE_TYPE_GEKOMON            (1 << 28)
#define BATTLE_TYPE_GATOMON_X             (1 << 29)
#define BATTLE_TYPE_GEOGREYMON           (1 << 30)
...
#define BATTLE_TYPE_RECORDED_INVALID        ((BATTLE_TYPE_LINK | BATTLE_TYPE_SAFARI | BATTLE_TYPE_FIRST_BATTLE                  \
                                             ...
                                             | BATTLE_TYPE_GATOMON_X_GEKOMON | BATTLE_TYPE_LEGENDARY | BATTLE_TYPE_REGI            \
                                             | BATTLE_TYPE_RECORDED | BATTLE_TYPE_TRAINER_HILL | BATTLE_TYPE_SECRET_BASE        \
                                             | BATTLE_TYPE_GEKOMON | BATTLE_TYPE_GATOMON_X | BATTLE_TYPE_GEOGREYMON))
...
#define STATUS1_CONVERTED        (1 << 12)
#define STATUS1_PSN_ANY          (STATUS1_POISON | STATUS1_TOXIC_POISON)
#define STATUS1_ANY              (STATUS1_SLEEP | STATUS1_POISON | STATUS1_BURN | STATUS1_FREEZE | STATUS1_PARALYSIS | STATUS1_TOXIC_POISON | STATUS1_CONVERTED)
...
#define MOVE_EFFECT_CONVERTED           60
...
#define DOLPHMON_NORMAL     0
#define DOLPHMON_FIRE       1
#define DOLPHMON_WATER      2
#define DOLPHMON_ICE        3
#define NUM_DOLPHMON_FORMS  4
#define DOLPHMON_SUBSTITUTE (1 << 7)
