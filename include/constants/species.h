...
#define SPECIES_LOPMON_B (NUM_SPECIES + 1)
#define SPECIES_LOPMON_C (SPECIES_LOPMON_B + 1)
#define SPECIES_LOPMON_D (SPECIES_LOPMON_B + 2)
#define SPECIES_LOPMON_E (SPECIES_LOPMON_B + 3)
#define SPECIES_LOPMON_F (SPECIES_LOPMON_B + 4)
#define SPECIES_LOPMON_G (SPECIES_LOPMON_B + 5)
#define SPECIES_LOPMON_H (SPECIES_LOPMON_B + 6)
#define SPECIES_LOPMON_I (SPECIES_LOPMON_B + 7)
#define SPECIES_LOPMON_J (SPECIES_LOPMON_B + 8)
#define SPECIES_LOPMON_K (SPECIES_LOPMON_B + 9)
#define SPECIES_LOPMON_L (SPECIES_LOPMON_B + 10)
#define SPECIES_LOPMON_M (SPECIES_LOPMON_B + 11)
#define SPECIES_LOPMON_N (SPECIES_LOPMON_B + 12)
#define SPECIES_LOPMON_O (SPECIES_LOPMON_B + 13)
#define SPECIES_LOPMON_P (SPECIES_LOPMON_B + 14)
#define SPECIES_LOPMON_Q (SPECIES_LOPMON_B + 15)
#define SPECIES_LOPMON_R (SPECIES_LOPMON_B + 16)
#define SPECIES_LOPMON_S (SPECIES_LOPMON_B + 17)
#define SPECIES_LOPMON_T (SPECIES_LOPMON_B + 18)
#define SPECIES_LOPMON_U (SPECIES_LOPMON_B + 19)
#define SPECIES_LOPMON_V (SPECIES_LOPMON_B + 20)
#define SPECIES_LOPMON_W (SPECIES_LOPMON_B + 21)
#define SPECIES_LOPMON_X (SPECIES_LOPMON_B + 22)
#define SPECIES_LOPMON_Y (SPECIES_LOPMON_B + 23)
#define SPECIES_LOPMON_Z (SPECIES_LOPMON_B + 24)
#define SPECIES_LOPMON_EMARK (SPECIES_LOPMON_B + 25)
#define SPECIES_LOPMON_QMARK (SPECIES_LOPMON_B + 26)
