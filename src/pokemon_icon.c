...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_ANGELAMON] = gMonIcon_Angelamon,
    ...
    [SPECIES_FLYBEEMON] = gMonIcon_Flybeemon,
    ...
    [SPECIES_EYESMON_SCATTERMODE] = gMonIcon_Eyesmon_scattermode,
    [SPECIES_FANGMON] = gMonIcon_Fangmon,
    [SPECIES_FILMON] = gMonIcon_Filmon,
    [SPECIES_DARCMON] = gMonIcon_Darcmon,
    [SPECIES_TRAILMON_DARK] = gMonIcon_Trailmon_dark,
    [SPECIES_EXVEEMON_VIRUS] = gMonIcon_Exveemon_virus,
    [SPECIES_EYESMON] = gMonIcon_Eyesmon,
    ...
    [SPECIES_EXVEEMON] = gMonIcon_Exveemon,
    ...
    [SPECIES_FIRAMON] = gMonIcon_Firamon,
    [SPECIES_FLADRAMON] = gMonIcon_Fladramon,
    [SPECIES_FLAWIZAMON] = gMonIcon_Flawizamon,
    ...
    [SPECIES_FLARIZAMON] = gMonIcon_Flarizamon,
    ...
    [SPECIES_FLYMON] = gMonIcon_Flymon,
    [SPECIES_FRIGIMON] = gMonIcon_Frigimon,
    [SPECIES_FROGMON] = gMonIcon_Frogmon,
    [SPECIES_FUGAMON] = gMonIcon_Fugamon,
    [SPECIES_GANEMON] = gMonIcon_Ganemon,
    [SPECIES_GAOGAMON] = gMonIcon_Gaogamon,
    [SPECIES_GARGOMON] = gMonIcon_Gargomon,
    [SPECIES_GARGOYLMON] = gMonIcon_Gargoylmon,
    [SPECIES_GARURUMON] = gMonIcon_Garurumon,
    [SPECIES_GATOMON_X] = gMonIcon_Gatomon_x,
    [SPECIES_GEKOMON] = gMonIcon_Gekomon,
    [SPECIES_GEOGREYMON] = gMonIcon_Geogreymon,
