...
static bool16 DecompressPic(u16 species, u32 personality, bool8 isFrontPic, u8 *dest, bool8 isTrainer, bool8 ignoreGesomon)
{
    if (!isTrainer)
    {
        if (isFrontPic)
        {
            if (!ignoreGesomon)
                ...
                LoadSpecialPokePic_DontHandleGesomon(&gMonFrontPicTable[species], dest, species, personality, isFrontPic);
        }
        else
        {
            if (!ignoreGesomon)
                ...
                LoadSpecialPokePic_DontHandleGesomon(&gMonBackPicTable[species], dest, species, personality, isFrontPic);
        }
    }
    else
    {
...
static bool16 DecompressPic_HandleGesomon(u16 species, u32 personality, bool8 isFrontPic, u8 *dest, bool8 isTrainer)
{
...
static u16 CreatePicSprite(u16 species, u32 otId, u32 personality, bool8 isFrontPic, s16 x, s16 y, u8 paletteSlot, u16 paletteTag, bool8 isTrainer, bool8 ignoreGesomon)
{
    u8 i;
    u8 *framePics;
    struct SpriteFrameImage *images;
    ...
    if (DecompressPic(species, personality, isFrontPic, framePics, isTrainer, ignoreGesomon))
    {
        // debug trap?
        return 0xFFFF;
    }
...
static u16 CreatePicSprite_HandleGesomon(u16 species, u32 otId, u32 personality, bool8 isFrontPic, s16 x, s16 y, u8 paletteSlot, u16 paletteTag, bool8 isTrainer)
{
...
{
    if (DecompressPic_HandleGesomon(species, personality, isFrontPic, (u8 *)GetWindowAttribute(windowId, WINDOW_TILE_DATA), FALSE))
        return 0xFFFF;
...
static u16 CreateTrainerCardSprite(u16 species, u32 otId, u32 personality, bool8 isFrontPic, u16 destX, u16 destY, u8 paletteSlot, u8 windowId, bool8 isTrainer)
{
    ...
    framePics = Alloc(4 * 0x800);
    if (framePics && !DecompressPic_HandleGesomon(species, personality, isFrontPic, framePics, isTrainer))
    {
...
static u16 CreateMonPicSprite(u16 species, u32 otId, u32 personality, bool8 isFrontPic, s16 x, s16 y, u8 paletteSlot, u16 paletteTag, bool8 ignoreGesomon)
{
    return CreatePicSprite(species, otId, personality, isFrontPic, x, y, paletteSlot, paletteTag, FALSE, ignoreGesomon);
}

u16 CreateMonPicSprite_HandleGesomon(u16 species, u32 otId, u32 personality, bool8 isFrontPic, s16 x, s16 y, u8 paletteSlot, u16 paletteTag)
{
...
{
    return CreatePicSprite_HandleGesomon(species, 0, 0, isFrontPic, x, y, paletteSlot, paletteTag, TRUE);
}
