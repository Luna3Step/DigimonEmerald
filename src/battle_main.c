...
const u8 gTypeEffectiveness[429] =
{
    ...
    TYPE_DARK, TYPE_LIGHT, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_LIGHT, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_LIGHT, TYPE_POISON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_LIGHT, TYPE_ELECTRIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_LIGHT, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DARK, TYPE_LIGHT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_PSYCHIC, TYPE_LIGHT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_STEEL, TYPE_LIGHT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DRAGON, TYPE_LIGHT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FAIRY, TYPE_LIGHT, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_LIGHT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_POISON, TYPE_LIGHT, TYPE_MUL_NO_EFFECT,
    TYPE_FIRE, TYPE_LIGHT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WATER, TYPE_LIGHT, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_VACCNE, TYPE_VIRUS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_VACCNE, TYPE_DATA, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_VIRUS, TYPE_DATA, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_VIRUS, TYPE_VACCNE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DATA, TYPE_VACCNE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DATA, TYPE_VIRUS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FREE, TYPE_FREE, TYPE_MUL_NOT_EFFECTIVE,
...
const u8 gTypeNames[NUMBER_OF_MON_TYPES][TYPE_NAME_LENGTH + 1] =
{
    ...
    [TYPE_FAIRY] = _("FAIRY"),
    [TYPE_LIGHT] = _("LIGHT"),
    [TYPE_VACCNE] = _("VACCNE"),
    [TYPE_VIRUS] = _("VIRUS"),
    [TYPE_DATA] = _("DATA"),
    [TYPE_FREE] = _("FREE"),
    [TYPE_UKNOWN] = _("UKNOWN"),
};
...
void SpriteCB_FaintOpponentMon(struct Sprite *sprite)
{
    ...
    if (species == SPECIES_LOPMON)
    {
        ...
        if (unownForm == 0)
            unownSpecies = SPECIES_LOPMON;  // Use the A Unown form.
        else
