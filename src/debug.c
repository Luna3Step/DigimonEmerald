...
#define SOUND_LIST_BGM \
    ...
    X(MUS_WEATHER_GATOMON_X, "MUS-WEATHER-GATOMONX") \
    X(MUS_WEATHER_GROUDON, "MUS-WEATHER-GEKOMON") \
    ...
    X(MUS_RAYQUAZA_APPEARS, "MUS-GEOGREYMON-APPEARS") \
    ...
    X(MUS_VS_RAYQUAZA, "MUS-VS-GEOGREYMON") \
    ...
    X(MUS_VS_KYOGRE_GROUDON, "MUS-VS-GATOMONX-GEKOMON") \
    ...
    X(MUS_RG_JIGGLYPUFF, "MUS-RG-SANDMON") \
    ...
    X(MUS_RG_VS_DEOXYS, "MUS-RG-VS-GESOMON") \
    ...
    X(MUS_RG_ENCOUNTER_DEOXYS, "MUS-RG-ENCOUNTER-GESOMON") \
...
#define SOUND_LIST_SE \
    ...
    X(SE_RG_DEOXYS_MOVE, "SE-RG-GESOMON-MOVE") \
