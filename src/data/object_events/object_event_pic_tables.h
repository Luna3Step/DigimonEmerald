...
static const struct SpriteFrameImage sPicTable_UnusedHawkmonDoll[] = {
    obj_frame_tiles(gObjectEventPic_UnusedHawkmonDoll),
};

static const struct SpriteFrameImage sPicTable_UnusedPickmon_whiteDoll[] = {
    obj_frame_tiles(gObjectEventPic_UnusedPickmon_whiteDoll),
};
...
static const struct SpriteFrameImage sPicTable_UnusedKudamonDoll[] = {
    obj_frame_tiles(gObjectEventPic_UnusedKudamonDoll),
};

static const struct SpriteFrameImage sPicTable_UnusedPetitmonDoll[] = {
    obj_frame_tiles(gObjectEventPic_UnusedPetitmonDoll),
};

static const struct SpriteFrameImage sPicTable_UnusedRenamon_xDoll[] = {
    obj_frame_tiles(gObjectEventPic_UnusedRenamon_xDoll),
};
...
static const struct SpriteFrameImage sPicTable_EnemyToyagumon[] = {
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 0),
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 1),
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 2),
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 3),
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 4),
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 5),
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 6),
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 7),
    overworld_frame(gObjectEventPic_EnemyToyagumon, 4, 4, 8),
};

static const struct SpriteFrameImage sPicTable_Tinkermon[] = {
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 0),
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 1),
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 2),
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 3),
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 4),
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 5),
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 6),
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 7),
    overworld_frame(gObjectEventPic_Tinkermon, 4, 4, 8),
};
...
static const struct SpriteFrameImage sPicTable_Guilmon_xDoll[] = {
    obj_frame_tiles(gObjectEventPic_Guilmon_xDoll),
};

static const struct SpriteFrameImage sPicTable_PetitmonDoll[] = {
...
static const struct SpriteFrameImage sPicTable_HagurumonDoll[] = {
    obj_frame_tiles(gObjectEventPic_HagurumonDoll),
};

static const struct SpriteFrameImage sPicTable_FloramonDoll[] = {
    obj_frame_tiles(gObjectEventPic_FloramonDoll),
};

static const struct SpriteFrameImage sPicTable_Falcomon_06Doll[] = {
    obj_frame_tiles(gObjectEventPic_Falcomon_06Doll),
};

static const struct SpriteFrameImage sPicTable_GammamonDoll[] = {
    obj_frame_tiles(gObjectEventPic_GammamonDoll),
};

static const struct SpriteFrameImage sPicTable_SandmonDoll[] = {
    obj_frame_tiles(gObjectEventPic_SandmonDoll),
};

static const struct SpriteFrameImage sPicTable_CalumonDoll[] = {
    obj_frame_tiles(gObjectEventPic_CalumonDoll),
};

static const struct SpriteFrameImage sPicTable_PuyomonDoll[] = {
    obj_frame_tiles(gObjectEventPic_PuyomonDoll),
};

static const struct SpriteFrameImage sPicTable_CrabmonDoll[] = {
    obj_frame_tiles(gObjectEventPic_CrabmonDoll),
};

static const struct SpriteFrameImage sPicTable_SangomonDoll[] = {
    obj_frame_tiles(gObjectEventPic_SangomonDoll),
};

static const struct SpriteFrameImage sPicTable_SunarzamonDoll[] = {
    obj_frame_tiles(gObjectEventPic_SunarzamonDoll),
};

static const struct SpriteFrameImage sPicTable_Syakomon_xDoll[] = {
    obj_frame_tiles(gObjectEventPic_Syakomon_xDoll),
};

static const struct SpriteFrameImage sPicTable_TerriermonDoll[] = {
    obj_frame_tiles(gObjectEventPic_TerriermonDoll),
};

static const struct SpriteFrameImage sPicTable_DrimogemonDoll[] = {
    obj_frame_tiles(gObjectEventPic_DrimogemonDoll),
};

static const struct SpriteFrameImage sPicTable_ExveemonDoll[] = {
    obj_frame_tiles(gObjectEventPic_ExveemonDoll),
};

static const struct SpriteFrameImage sPicTable_DexdorumonDoll[] = {
...
static const struct SpriteFrameImage sPicTable_BiostegmonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BiostegmonDoll),
};

static const struct SpriteFrameImage sPicTable_BirdramonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BirdramonDoll),
};

static const struct SpriteFrameImage sPicTable_DarlizamonDoll[] = {
    obj_frame_tiles(gObjectEventPic_DarlizamonDoll),
};

static const struct SpriteFrameImage sPicTable_BuraimonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BuraimonDoll),
};

static const struct SpriteFrameImage sPicTable_ZubamonDoll[] = {
    obj_frame_tiles(gObjectEventPic_ZubamonDoll),
};

static const struct SpriteFrameImage sPicTable_AirdramonDoll[] = {
    obj_frame_tiles(gObjectEventPic_AirdramonDoll),
};
...
static const struct SpriteFrameImage sPicTable_BigDracomonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BigDracomonDoll),
};

static const struct SpriteFrameImage sPicTable_BigBakomonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BigBakomonDoll),
};

static const struct SpriteFrameImage sPicTable_BigcoronamonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BigcoronamonDoll),
};

static const struct SpriteFrameImage sPicTable_BigBommonDoll[] = {
...
static const struct SpriteFrameImage sPicTable_BigcurimonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BigcurimonDoll),
};

static const struct SpriteFrameImage sPicTable_BigChamblemonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BigChamblemonDoll),
};

static const struct SpriteFrameImage sPicTable_BigGargomonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BigGargomonDoll),
};

static const struct SpriteFrameImage sPicTable_BigGargoylmonDoll[] = {
    obj_frame_tiles(gObjectEventPic_BigGargoylmonDoll),
};

static const struct SpriteFrameImage sPicTable_BigGarurumonDoll[] = {
...
static const struct SpriteFrameImage sPicTable_Birdramon[] = {
    overworld_frame(gObjectEventPic_Birdramon, 2, 2, 0),
    overworld_frame(gObjectEventPic_Birdramon, 2, 2, 1),
...
static const struct SpriteFrameImage sPicTable_Petitmon[] = {
    overworld_frame(gObjectEventPic_Petitmon, 2, 2, 0),
    overworld_frame(gObjectEventPic_Petitmon, 2, 2, 1),
...
static const struct SpriteFrameImage sPicTable_Biostegmon[] = {
    overworld_frame(gObjectEventPic_Biostegmon, 2, 2, 0),
    overworld_frame(gObjectEventPic_Biostegmon, 2, 2, 1),
    overworld_frame(gObjectEventPic_Biostegmon, 2, 2, 2),
    overworld_frame(gObjectEventPic_Biostegmon, 2, 2, 0),
    overworld_frame(gObjectEventPic_Biostegmon, 2, 2, 0),
    overworld_frame(gObjectEventPic_Biostegmon, 2, 2, 1),
    overworld_frame(gObjectEventPic_Biostegmon, 2, 2, 1),
...
static const struct SpriteFrameImage sPicTable_Ebidramon[] = {
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 1),
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 2),
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 3),
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 4),
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 5),
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 6),
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 7),
    overworld_frame(gObjectEventPic_Ebidramon, 2, 4, 8),
};

static const struct SpriteFrameImage sPicTable_Aquilamon[] = {
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 1),
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 2),
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 3),
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 4),
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 5),
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 6),
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 7),
    overworld_frame(gObjectEventPic_Aquilamon, 2, 4, 8),
};
...
static const struct SpriteFrameImage sPicTable_Junkmon[] = {
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 1),
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 1),
    overworld_frame(gObjectEventPic_Junkmon, 2, 4, 2),
};

static const struct SpriteFrameImage sPicTable_Falcomon[] = {
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 0),
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 1),
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 2),
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 3),
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 4),
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 5),
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 6),
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 7),
    overworld_frame(gObjectEventPic_Falcomon, 2, 4, 8),
};
...
static const struct SpriteFrameImage sPicTable_Sparrowmon[] = {
    overworld_frame(gObjectEventPic_Sparrowmon, 4, 4, 0),
    overworld_frame(gObjectEventPic_Sparrowmon, 4, 4, 0),
    overworld_frame(gObjectEventPic_Sparrowmon, 4, 4, 0),
    overworld_frame(gObjectEventPic_Sparrowmon, 4, 4, 0),
