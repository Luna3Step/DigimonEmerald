...
const u16 DecorGfx_GUILMON_X_DOLL[] = {
    OBJ_EVENT_GFX_GUILMON_X_DOLL
};
...
const u16 DecorGfx_JAZAMON_DOLL[] = {
    OBJ_EVENT_GFX_JAZAMON_DOLL
};
...
const u16 DecorGfx_GAMMAMON_DOLL[] = {
    OBJ_EVENT_GFX_GAMMAMON_DOLL
};

const u16 DecorGfx_SANDMON_DOLL[] = {
...
const u16 DecorGfx_SANGOMON_DOLL[] = {
    OBJ_EVENT_GFX_SANGOMON_DOLL
};

const u16 DecorGfx_SUNARZAMON_DOLL[] = {
...
const u16 DecorGfx_TERRIERMON_DOLL[] = {
    OBJ_EVENT_GFX_TERRIERMON_DOLL
};

const u16 DecorGfx_DRIMOGEMON_DOLL[] = {
...
const u16 DecorGfx_DONSHOUMON_DOLL[] = {
    OBJ_EVENT_GFX_DONSHOUMON_DOLL
};

const u16 DecorGfx_BIOSTEGMON_DOLL[] = {
    OBJ_EVENT_GFX_BIOSTEGMON_DOLL
};

const u16 DecorGfx_BIRDRAMON_DOLL[] = {
    OBJ_EVENT_GFX_BIRDRAMON_DOLL
};

const u16 DecorGfx_DARLIZAMON_DOLL[] = {
    OBJ_EVENT_GFX_DARLIZAMON_DOLL
};

const u16 DecorGfx_BURAIMON_DOLL[] = {
    OBJ_EVENT_GFX_BURAIMON_DOLL
};
...
const u16 DecorGfx_AIRDRAMON_DOLL[] = {
    OBJ_EVENT_GFX_AIRDRAMON_DOLL
};
...
const u16 DecorGfx_DRACOMON_DOLL[] = {
    OBJ_EVENT_GFX_BIG_DRACOMON_DOLL
};
...
const u16 DecorGfx_BOMMON_DOLL[] = {
    OBJ_EVENT_GFX_BIG_BOMMON_DOLL
};

const u16 DecorGfx_CHIBOMON_DOLL[] = {
    OBJ_EVENT_GFX_BIG_CHIBOMON_DOLL
};

const u16 DecorGfx_curimon_DOLL[] = {
    OBJ_EVENT_GFX_BIG_curimon_DOLL
};

const u16 DecorGfx_CHAMBLEMON_DOLL[] = {
    OBJ_EVENT_GFX_BIG_CHAMBLEMON_DOLL
};

const u16 DecorGfx_GARGOMON_DOLL[] = {
...
const u16 DecorGfx_GARURUMON_DOLL[] = {
    OBJ_EVENT_GFX_BIG_GARURUMON_DOLL
};
