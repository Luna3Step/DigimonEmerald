const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_STARMON_2010] = _("STARMON"),
    ...
    [SPECIES_DONSHOUMON] = _("DONSHOUMON"),
    [SPECIES_DEXDORUMON] = _("DEXDORUMON"),
    [SPECIES_DIATRYMON] = _("DIATRYMON"),
    [SPECIES_BIOTHUNMON] = _("BIOTHUNMON"),
    [SPECIES_CLOCKMON] = _("CLOCKMON"),
    [SPECIES_BLGARGOMON] = _("BLGARGOMON"),
    [SPECIES_DEPTHMON] = _("DEPTHMON"),
    [SPECIES_DEPUTYMON] = _("DEPUTYMON"),
    [SPECIES_FLYBEEMON] = _("FLYBEEMON"),
    [SPECIES_DEVIDRAMON] = _("DEVIDRAMON"),
    [SPECIES_DEVIMON] = _("DEVIMON"),
    [SPECIES_DOGGYMON] = _("DOGGYMON"),
    [SPECIES_DOKUGUMON] = _("DOKUGUMON"),
    ...
    [SPECIES_DAMEMON_FUSION] = _("DAMEMON"),
    ...
    [SPECIES_EYESMON_SCATTERMODE] = _("EYESMON"),
    [SPECIES_FANGMON] = _("FANGMON"),
    [SPECIES_FILMON] = _("FILMON"),
    [SPECIES_DARCMON] = _("DARCMON"),
    [SPECIES_TRAILMON_DARK] = _("TRAILMON"),
    [SPECIES_EXVEEMON_VIRUS] = _("EXVEEMON"),
    [SPECIES_EYESMON] = _("EYESMON"),
    ...
    [SPECIES_EXVEEMON] = _("EXVEEMON"),
    [SPECIES_DRIMOGEMON] = _("DRIMOGEMON"),
    [SPECIES_EBIDRAMON] = _("EBIDRAMON"),
    ...
    [SPECIES_ELEPHANMON] = _("ELEPHANMON"),
    [SPECIES_BAOHUCKMON] = _("BAOHUCKMON"),
    [SPECIES_BAROMON] = _("BAROMON"),
    [SPECIES_TRAILMON_BATTLE_ARMAMENT] = _("TRAILMON"),
    [SPECIES_FIRAMON] = _("FIRAMON"),
    [SPECIES_FLADRAMON] = _("FLADRAMON"),
    [SPECIES_FLAWIZAMON] = _("FLAWIZAMON"),
    [SPECIES_EXERMON] = _("EXERMON"),
    [SPECIES_DORUGAMON] = _("DORUGAMON"),
    [SPECIES_DORULUMON] = _("DORULUMON"),
    [SPECIES_DARKTYRMON_X] = _("DARKTYRMON"),
    [SPECIES_DARKTYRMON] = _("DARKTYRMON"),
    [SPECIES_FLARIZAMON] = _("FLARIZAMON"),
    [SPECIES_BLKGATOMON] = _("BLKGATOMON"),
    [SPECIES_BLKGATOMON_UVER] = _("BLKGATOMON"),
    [SPECIES_BLGROWLMON] = _("BLGROWLMON"),
    [SPECIES_DOLPHMON] = _("DOLPHMON"),
    [SPECIES_BUCCHIEMON_GREEN] = _("BUCCHIEMON"),
    [SPECIES_BULKMON] = _("BULKMON"),
    [SPECIES_DIGMON] = _("DIGMON"),
    [SPECIES_DINOHYUMON] = _("DINOHYUMON"),
    [SPECIES_DOBERMON] = _("DOBERMON"),
    [SPECIES_DOBERMON_X] = _("DOBERMON"),
    [SPECIES_APEMON] = _("APEMON"),
    [SPECIES_AQUILAMON] = _("AQUILAMON"),
    [SPECIES_ARCADIAMON_CHAMPION] = _("ARCADIAMON"),
    [SPECIES_FLYMON] = _("FLYMON"),
    [SPECIES_FRIGIMON] = _("FRIGIMON"),
    [SPECIES_FROGMON] = _("FROGMON"),
    [SPECIES_FUGAMON] = _("FUGAMON"),
    [SPECIES_GANEMON] = _("GANEMON"),
    [SPECIES_GAOGAMON] = _("GAOGAMON"),
    [SPECIES_GARGOMON] = _("GARGOMON"),
    [SPECIES_GARGOYLMON] = _("GARGOYLMON"),
    [SPECIES_GARURUMON] = _("GARURUMON"),
    [SPECIES_GATOMON_X] = _("GATOMON"),
    [SPECIES_GEKOMON] = _("GEKOMON"),
    [SPECIES_GEOGREYMON] = _("GEOGREYMON"),
    [SPECIES_GARURUMON_X] = _("GARURUMON"),
    [SPECIES_GATOMON] = _("GATOMON"),
    [SPECIES_GEREMON] = _("GEREMON"),
    [SPECIES_GESOMON] = _("GESOMON"),
    [SPECIES_EOSMON_CHAMPION] = _("EOSMON"),
};
