const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_BLESSING] = _("BLESSING"),
    [MOVE_HOLY_BEAM] = _("HOLY BEAM"),
    ...
    [MOVE_ELECTROSHOCK] = _("ELECTROSHOCK"),
    [MOVE_HORN_BUSTER] = _("HORN BUSTER"),
    [MOVE_GIGA_SCISSOR] = _("GIGA SCISSOR"),
    ...
    [MOVE_STUN_STINGER] = _("STUN STINGER"),
    [MOVE_HOLY_SHOOT] = _("HOLY SHOOT"),
    [MOVE_CORONA_FLAME] = _("CORONA FLAME"),
    [MOVE_GRAND_CROSS] = _("GRAND CROSS"),
    [MOVE_CELSTL_CROSS] = _("CELSTL CROSS"),
    ...
    [MOVE_DISARMING_VOICE] = _("SWEET VOICE"),
    ...
    [MOVE_METEOR_ASSAULT] = _("METEOR RAID"),
