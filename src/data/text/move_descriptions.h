...
static const u8 sBlessingDescription[] = _(
...
static const u8 sDrglessSpkrDescription[] = _(
    "Bisects the enemy with its\n"
    "claws. High critical-hit ratio ");

static const u8 sMudBombDescription[] = _(
    "The user launches a hard mud\n"
    "ball. This may lower accuracy");
...
static const u8 sPoisonJabDescription[] = _(
    "The foe is stabbed with poison.\n"
...
static const u8 sDragonPulseDescription[] = _(
    "The foe is hit with a shockwave\n"
    "generated by the users mouth.");
...
static const u8 sWorkUpDescription[] = _(
    "The user is roused raising\n"
    "its ATK and SP. ATK");

static const u8 sCloseCombatDescription[] = _(
    "The user fights without any\n"
    "guard lowering DEF and SP. DEF");
...
static const u8 sPowerWhipDescription[] = _(
    ...
    "tentacles or vines at the foe");

static const u8 sBraveBirdDescription[] = _(
    "The user tucks and charges\n"
    "damaging the user and foe");

static const u8 sPowerUpPunchDescription[] = _(
    "The user strikes with a well\n"
...
static const u8 sHornBusterDescription[] = _(
...
static const u8 sBabyFlameDescription[] = _(
    "The user breathes out spicy flames\n"
    "at the foe. Always burns");

static const u8 sBlueBlasterDescription[] = _(
...
static const u8 sOrderUpDescription[] = _(
    "The user attacks with elegant\n"
    "poise as it dishes up");
...
static const u8 sGaoRushDescription[] = _(
    "The user throws several high-speed\n"
    "punches hitting 2-5 times.");

static const u8 sDashDoubleClawDescription[] = _(
...
static const u8 sNuzzleDescription[] = _(
    ...
    "cheeks on the foe. Always paralyses.");

static const u8 sShockQuillDescription[] = _(
    "The user repeatedly fires\n"
    "electrified quills 2-5 times.");

static const u8 sZingZapDescription[] = _(
    "A strong electric blast crashes\n"
    "onto the foe. May flinch them.");

static const u8 sParachargeDescription[] = _(
    "The user attacks everything\n"
    "around it healing itself.");

static const u8 sStunStingerDescription[] = _(
    "The user skewers the foe with\n"
    "its quills. Lowers SP. DEF.");

static const u8 sHolyShootDescription[] = _(
    "The user causes an explosion\n"
    "with a small ball of light.");

static const u8 sCoronaFlameDescription[] = _(
...
static const u8 sCelstlCrossDescription[] = _(
    "The user passes judgement with\n"
    "a holy sword. Converts the foe");

static const u8 sDrumBeatingDescription[] = _(
    "The user plays its drum to\n"
    "control roots. This may lower SPD");

static const u8 sDrainPunchDescription[] = _(
    "An energy-draining punch. Restores\n"
    "the users HP on hit");
...
static const u8 sNightDazeDescription[] = _(
    ...
    "shock wave that may lower Accuracy");

static const u8 sFieryWrathDescription[] = _(
    "The user transforms its wrath into\n"
    "a fire-like aura. Foes may flinch");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_SHOCK_QUILL - 1] = sShockQuillDescription, 
    [MOVE_ZING_ZAP - 1] = sZingZapDescription, 
    [MOVE_PARACHARGE - 1] = sParachargeDescription, 
    ...
    [MOVE_CELSTL_CROSS - 1] = sCelstlCrossDescription, 
