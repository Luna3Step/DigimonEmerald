const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_ARMADILMON]    = {{EVO_SPDEFENSE, 51, SPECIES_CHAMELEMON},
                               {EVO_HEALTH, 93, SPECIES_ELEPHANMON},
                               {EVO_ITEM, ITEM_SUN_STONE, SPECIES_DIGMON},
    ...
    [SPECIES_BLKAGUMON]     = {{EVO_LEVEL, 40, SPECIES_DARKTYRMON}},
    ...
    [SPECIES_GABUMON]    = {{EVO_LEVEL, 36, SPECIES_GARURUMON}},
    ...
    [SPECIES_GOMAMON]   = {{EVO_LEVEL, 35, SPECIES_GAOGAMON}},
    [SPECIES_GOMAMON_X]     = {{EVO_LEVEL, 32, SPECIES_EBIDRAMON}},
    [SPECIES_GOTSUMON]   = {{EVO_LEVEL, 33, SPECIES_BIOSTEGMON}},
    ...
    [SPECIES_HAWKMON]       = {{EVO_ATTACK, 52, SPECIES_ALLOMON},
                              {EVO_SPEED, 55, SPECIES_FLYBEEMON},
    ...
    [SPECIES_KERAMON]     = {{EVO_LEVEL, 40, SPECIES_CHRYSALMON}},
    ...
    [SPECIES_KOKUWAMON]    = {{EVO_LEVEL, 45, SPECIES_TRAILMON_BATTLE_ARMAMENT}},
    ...
    [SPECIES_LOPMON]     = {{EVO_LEVEL, 39, SPECIES_GARGOYLMON}},
    ...
    [SPECIES_RENAMON]   = {{EVO_LEVEL, 28, SPECIES_BLKGATOMON}},
    ...
    [SPECIES_SALAMON_X]   = {{EVO_LEVEL, 40, SPECIES_BLIMPMON}},
    ...
    [SPECIES_SYAKOMON]   = {{EVO_LEVEL, 35, SPECIES_GESOMON}},
    ...
    [SPECIES_VEEMON]    = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_EXVEEMON_VIRUS},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLADRAMON},
    ...
    [SPECIES_WORMMON]    = {{EVO_SPEED, 51, SPECIES_AURUMON},
                           {EVO_DEFENSE, 51, SPECIES_BUCCHIEMON_RED},
                           {EVO_HEALTH, 89, SPECIES_BUCCHIEMON_RED},
                           {EVO_ATTACK, 53, SPECIES_BUCCHIEMON_GREEN},
