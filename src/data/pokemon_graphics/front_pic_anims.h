...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_LOPMON_B]     = sAnims_UnownB,
    [SPECIES_LOPMON_C]     = sAnims_UnownC,
    [SPECIES_LOPMON_D]     = sAnims_UnownD,
    [SPECIES_LOPMON_E]     = sAnims_UnownE,
    [SPECIES_LOPMON_F]     = sAnims_UnownF,
    [SPECIES_LOPMON_G]     = sAnims_UnownG,
    [SPECIES_LOPMON_H]     = sAnims_UnownH,
    [SPECIES_LOPMON_I]     = sAnims_UnownI,
    [SPECIES_LOPMON_J]     = sAnims_UnownJ,
    [SPECIES_LOPMON_K]     = sAnims_UnownK,
    [SPECIES_LOPMON_L]     = sAnims_UnownL,
    [SPECIES_LOPMON_M]     = sAnims_UnownM,
    [SPECIES_LOPMON_N]     = sAnims_UnownN,
    [SPECIES_LOPMON_O]     = sAnims_UnownO,
    [SPECIES_LOPMON_P]     = sAnims_UnownP,
    [SPECIES_LOPMON_Q]     = sAnims_UnownQ,
    [SPECIES_LOPMON_R]     = sAnims_UnownR,
    [SPECIES_LOPMON_S]     = sAnims_UnownS,
    [SPECIES_LOPMON_T]     = sAnims_UnownT,
    [SPECIES_LOPMON_U]     = sAnims_UnownU,
    [SPECIES_LOPMON_V]     = sAnims_UnownV,
    [SPECIES_LOPMON_W]     = sAnims_UnownW,
    [SPECIES_LOPMON_X]     = sAnims_UnownX,
    [SPECIES_LOPMON_Y]     = sAnims_UnownY,
    [SPECIES_LOPMON_Z]     = sAnims_UnownZ,
    [SPECIES_LOPMON_EMARK] = sAnims_UnownEMark,
    [SPECIES_LOPMON_QMARK] = sAnims_UnownQMark,
