...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_BIRDRAMON]      = sAnims_Skitty,
    ...
    [SPECIES_CHOUFLYMON]    = sAnims_Carvanha,
    [SPECIES_CENTARUMON]    = sAnims_Sharpedo,
    ...
    [SPECIES_BIOSTEGMON]     = sAnims_Azurill,
    ...
    [SPECIES_BLGARURMON]      = sAnims_Mawile,
    [SPECIES_SAWKUWAMON]    = sAnims_Meditite,
    ...
    [SPECIES_BURGERMON_CHAMPION]      = sAnims_Swalot,
    [SPECIES_ELEPHANMON]     = sAnims_Tropius,
    [SPECIES_BAOHUCKMON]     = sAnims_Whismur,
    [SPECIES_BAROMON]     = sAnims_Loudred,
    ...
    [SPECIES_BLKGATOMON]        = sAnims_Aron,
    [SPECIES_BLKGATOMON_UVER]      = sAnims_Lairon,
