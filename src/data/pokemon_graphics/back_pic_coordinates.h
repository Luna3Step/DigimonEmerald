...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_LOPMON_B]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  9 },
    [SPECIES_LOPMON_C]     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  6 },
    [SPECIES_LOPMON_D]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  8 },
    [SPECIES_LOPMON_E]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 10 },
    [SPECIES_LOPMON_F]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_LOPMON_G]     = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  5 },
    [SPECIES_LOPMON_H]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_LOPMON_I]     = { .size = MON_COORDS_SIZE(24, 56), .y_offset =  7 },
    [SPECIES_LOPMON_J]     = { .size = MON_COORDS_SIZE(32, 48), .y_offset =  9 },
    [SPECIES_LOPMON_K]     = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  7 },
    [SPECIES_LOPMON_L]     = { .size = MON_COORDS_SIZE(32, 48), .y_offset = 10 },
    [SPECIES_LOPMON_M]     = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
    [SPECIES_LOPMON_N]     = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
    [SPECIES_LOPMON_O]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_LOPMON_P]     = { .size = MON_COORDS_SIZE(32, 48), .y_offset = 10 },
    [SPECIES_LOPMON_Q]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 15 },
    [SPECIES_LOPMON_R]     = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 12 },
    [SPECIES_LOPMON_S]     = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  4 },
    [SPECIES_LOPMON_T]     = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 13 },
    [SPECIES_LOPMON_U]     = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
    [SPECIES_LOPMON_V]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 11 },
    [SPECIES_LOPMON_W]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 13 },
    [SPECIES_LOPMON_X]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 15 },
    [SPECIES_LOPMON_Y]     = { .size = MON_COORDS_SIZE(32, 48), .y_offset = 10 },
    [SPECIES_LOPMON_Z]     = { .size = MON_COORDS_SIZE(32, 48), .y_offset = 10 },
    [SPECIES_LOPMON_EMARK] = { .size = MON_COORDS_SIZE(24, 56), .y_offset =  6 },
    [SPECIES_LOPMON_QMARK] = { .size = MON_COORDS_SIZE(32, 56), .y_offset =  6 },
};
