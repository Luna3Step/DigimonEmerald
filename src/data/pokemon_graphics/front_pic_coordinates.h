...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_LOPMON_B]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 16 },
    [SPECIES_LOPMON_C]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 16 },
    [SPECIES_LOPMON_D]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 16 },
    [SPECIES_LOPMON_E]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 17 },
    [SPECIES_LOPMON_F]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 17 },
    [SPECIES_LOPMON_G]     = { .size = MON_COORDS_SIZE(24, 40), .y_offset = 14 },
    [SPECIES_LOPMON_H]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 16 },
    [SPECIES_LOPMON_I]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 16 },
    [SPECIES_LOPMON_J]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 17 },
    [SPECIES_LOPMON_K]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 17 },
    [SPECIES_LOPMON_L]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 19 },
    [SPECIES_LOPMON_M]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 19 },
    [SPECIES_LOPMON_N]     = { .size = MON_COORDS_SIZE(32, 24), .y_offset = 20 },
    [SPECIES_LOPMON_O]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 16 },
    [SPECIES_LOPMON_P]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 19 },
    [SPECIES_LOPMON_Q]     = { .size = MON_COORDS_SIZE(32, 24), .y_offset = 21 },
    [SPECIES_LOPMON_R]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 19 },
    [SPECIES_LOPMON_S]     = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 12 },
    [SPECIES_LOPMON_T]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 18 },
    [SPECIES_LOPMON_U]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 18 },
    [SPECIES_LOPMON_V]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 18 },
    [SPECIES_LOPMON_W]     = { .size = MON_COORDS_SIZE(32, 32), .y_offset = 19 },
    [SPECIES_LOPMON_X]     = { .size = MON_COORDS_SIZE(24, 24), .y_offset = 21 },
    [SPECIES_LOPMON_Y]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 17 },
    [SPECIES_LOPMON_Z]     = { .size = MON_COORDS_SIZE(24, 32), .y_offset = 16 },
    [SPECIES_LOPMON_EMARK] = { .size = MON_COORDS_SIZE(24, 40), .y_offset = 15 },
    [SPECIES_LOPMON_QMARK] = { .size = MON_COORDS_SIZE(24, 40), .y_offset = 13 },
};
