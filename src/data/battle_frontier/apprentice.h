...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SWELLOW, SPECIES_SWALOT, SPECIES_MORPHOMON, SPECIES_MANECTRIC, SPECIES_TORKOAL, SPECIES_HARIYAMA, SPECIES_TINPET, SPECIES_AGUNIMON, SPECIES_CRAWDAUNT, SPECIES_WHISCASH},
        .id = 1,
