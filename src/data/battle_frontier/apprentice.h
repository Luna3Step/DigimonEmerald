...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_ANGELAMON, SPECIES_SWALOT, SPECIES_MORPHOMON, SPECIES_BOMNANIMON, SPECIES_TORKOAL, SPECIES_BIOQUETMON, SPECIES_TINPET, SPECIES_AGUNIMON, SPECIES_CRAWDAUNT, SPECIES_WHISCASH},
        .id = 1,
