...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_POYOMON, SPECIES_DAMEMON, SPECIES_CLAYDOL, SPECIES_ARMALDO, SPECIES_GOTSUMON, SPECIES_CRADILY, SPECIES_SOLROCK, SPECIES_DECKDRAMON, SPECIES_MOTIMON},
        .id = 14,
