...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_POYOMON, SPECIES_DAMEMON, SPECIES_DIATRYMON, SPECIES_ARMALDO, SPECIES_GOTSUMON, SPECIES_CRADILY, SPECIES_DELTAMON, SPECIES_DECKDRAMON, SPECIES_MOTIMON},
        .id = 14,
