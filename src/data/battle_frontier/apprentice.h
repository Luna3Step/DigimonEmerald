...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_ARCADIAMON_IT, SPECIES_IMPMON_X, SPECIES_BULLMON, SPECIES_PATAMON, SPECIES_DAMEMON, SPECIES_ATAMADEMON, SPECIES_MILOTIC, SPECIES_DARMAILMON, SPECIES_DINOHYUMON},
        .id = 8,
