...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_BURGERMON_CHAMPION, SPECIES_HERISSMON, SPECIES_ALTARIA, SPECIES_DEMMERAMON, SPECIES_DAMEMON, SPECIES_KAPURIMON, SPECIES_ARCADIAMON_CHAMPION, SPECIES_CHAMELEMON, SPECIES_COELAMON, SPECIES_TINPET},
        .id = 3,
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_ARCADIAMON_IT, SPECIES_IMPMON_X, SPECIES_BULLMON, SPECIES_PATAMON, SPECIES_DAMEMON, SPECIES_ATAMADEMON, SPECIES_MILOTIC, SPECIES_ALTARIA, SPECIES_CRADILY},
        .id = 8,
