...
const struct ApprenticeTrainer gApprentices[NUM_APPRENTICES] =
{
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_ARCADIAMON_IT, SPECIES_IMPMON_X, SPECIES_BULLMON, SPECIES_PATAMON, SPECIES_DAMEMON, SPECIES_ATAMADEMON, SPECIES_DOKUGUMON, SPECIES_DARMAILMON, SPECIES_DINOHYUMON},
        .id = 8,
    ...
    },
    {
        ...
        .species = {SPECIES_SYAKOMON, SPECIES_POYOMON, SPECIES_DAMEMON, SPECIES_DIATRYMON, SPECIES_DOBERMON_X, SPECIES_GOTSUMON, SPECIES_DINOHYUMON, SPECIES_DELTAMON, SPECIES_DECKDRAMON, SPECIES_MOTIMON},
        .id = 14,
