...
{
    [CONTEST_CATEGORY_COOL]   = OBJ_EVENT_GFX_TOYAGUMON_1,
    [CONTEST_CATEGORY_BEAUTY] = OBJ_EVENT_GFX_BIRDRAMON,
    [CONTEST_CATEGORY_CUTE]   = OBJ_EVENT_GFX_TINKERMON,
    [CONTEST_CATEGORY_SMART]  = OBJ_EVENT_GFX_DONSHOUMON,
    [CONTEST_CATEGORY_TOUGH]  = OBJ_EVENT_GFX_PETITMON
};
...
{
    [CONTEST_CATEGORY_COOL]   = SPECIES_TOYAGUMON,
    [CONTEST_CATEGORY_BEAUTY] = SPECIES_BIRDRAMON,
    [CONTEST_CATEGORY_CUTE]   = SPECIES_TINKERMON,
    [CONTEST_CATEGORY_SMART]  = SPECIES_DONSHOUMON,
    [CONTEST_CATEGORY_TOUGH]  = SPECIES_PETITMON
};
