...
{
    SPECIES_FALCOMON, SPECIES_AGUMON_FAKE_EXPERT, SPECIES_STARMON_2010, SPECIES_SPARROWMON, SPECIES_STRABIMON,
    SPECIES_GATOMON_X, SPECIES_GEKOMON, SPECIES_GEOGREYMON, SPECIES_GEREMON, SPECIES_GESOMON, 0xFFFF
};
