...
#define SQU_GREEN_EXVEEMON    (ROW_GREEN + COL_EXVEEMON)
...
#define SQU_PURPLE_EXVEEMON   (ROW_PURPLE + COL_EXVEEMON)
...
#define F_EXVEEMON_COL      (1 << COL_EXVEEMON)
...
#define F_ORANGE_EXVEEMON   (1 << SQU_ORANGE_EXVEEMON)
...
#define F_GREEN_EXVEEMON    (1 << SQU_GREEN_EXVEEMON)
...
#define F_PURPLE_EXVEEMON   (1 << SQU_PURPLE_EXVEEMON)
...
#define SPR_WHEEL_ICONS SPR_WHEEL_ICON_ORANGE_EXVEEMON
#define SPR_BALL_COUNTER SPR_BALL_COUNTER_1
#define SPR_CREDIT_DIGITS SPR_CREDIT_DIG_1
#define SPR_GRID_ICONS SPR_GRID_ICON_ORANGE_EXVEEMON
...
static const struct GridSelection sGridSelections[NUM_GRID_SELECTIONS + 1] =
{
    ...
    [COL_EXVEEMON] = {
        ...
        .tilemapOffset = 0,
        .flag = F_EXVEEMON_COL,
        .inSelectionFlags = F_EXVEEMON_COL | F_ORANGE_EXVEEMON | F_GREEN_EXVEEMON | F_PURPLE_EXVEEMON,
    ...
    [COL_BETGAMAMON] = {
        ...
        .var05 = 0,
        .tilemapOffset = 0,
        .flag = F_BETGAMAMON_COL,
        .inSelectionFlags = F_BETGAMAMON_COL | F_ORANGE_BETGAMAMON | F_GREEN_BETGAMAMON | F_PURPLE_BETGAMAMON,
        .flashFlags = F_FLASH_COLUMN,
    },
    [ROW_ORANGE] = {
        .spriteIdOffset = 16,
        ...
        .tilemapOffset = 12,
        .flag = F_ORANGE_ROW,
        .inSelectionFlags = F_ORANGE_ROW | F_ORANGE_EXVEEMON | F_ORANGE_BIOSTEGMON | F_ORANGE_BIRDRAMON | F_ORANGE_BETGAMAMON,
        .flashFlags = F_FLASH_COLOR_O_EXVEEMON | F_FLASH_COLOR_O_BIOSTEGMON | F_FLASH_COLOR_O_BIRDRAMON | F_FLASH_COLOR_O_BETGAMAMON,
    },
    [SQU_ORANGE_EXVEEMON] = {
        .spriteIdOffset = 0,
        ...
        .var05 = 3,
        .tilemapOffset = 3,
        .flag = F_ORANGE_EXVEEMON,
        .inSelectionFlags = F_ORANGE_EXVEEMON,
        .flashFlags = F_FLASH_ICON | F_FLASH_COLOR_O_EXVEEMON,
    },
    [SQU_ORANGE_BIOSTEGMON] = {
        .spriteIdOffset = 9,
        .baseMultiplier = NUM_ROULETTE_SLOTS,
        .column = 2,
        .row = 1,
    ...
    [SQU_ORANGE_BETGAMAMON] = {
        ...
        .var05 = 3,
        .tilemapOffset = 3,
        .flag = F_ORANGE_BETGAMAMON,
        .inSelectionFlags = F_ORANGE_BETGAMAMON,
        .flashFlags = F_FLASH_ICON | F_FLASH_COLOR_O_BETGAMAMON,
    },
    [ROW_GREEN] = {
        .spriteIdOffset = 17,
        .baseMultiplier = NUM_BOARD_COLORS,
        ...
        .tilemapOffset = 15,
        .flag = F_GREEN_ROW,
        .inSelectionFlags = F_GREEN_ROW | F_GREEN_EXVEEMON | F_GREEN_BIOSTEGMON | F_GREEN_BIRDRAMON | F_GREEN_BETGAMAMON,
        .flashFlags = F_FLASH_COLOR_G_EXVEEMON | F_FLASH_COLOR_G_BIOSTEGMON | F_FLASH_COLOR_G_BIRDRAMON | F_FLASH_COLOR_G_BETGAMAMON,
    },
    [SQU_GREEN_EXVEEMON] = {
        .spriteIdOffset = 4,
        .baseMultiplier = NUM_ROULETTE_SLOTS,
        ...
        .var05 = 6,
        .tilemapOffset = 6,
        .flag = F_GREEN_EXVEEMON,
        .inSelectionFlags = F_GREEN_EXVEEMON,
        .flashFlags = F_FLASH_ICON | F_FLASH_COLOR_G_EXVEEMON,
    },
    [SQU_GREEN_BIOSTEGMON] = {
        .spriteIdOffset = 1,
        .baseMultiplier = NUM_ROULETTE_SLOTS,
        .column = 2,
        .row = 2,
    ...
    [SQU_GREEN_BETGAMAMON] = {
        ...
        .var05 = 6,
        .tilemapOffset = 6,
        .flag = F_GREEN_BETGAMAMON,
        .inSelectionFlags = F_GREEN_BETGAMAMON,
        .flashFlags = F_FLASH_ICON | F_FLASH_COLOR_G_BETGAMAMON,
    },
    [ROW_PURPLE] = {
        .spriteIdOffset = 18,
        .baseMultiplier = NUM_BOARD_COLORS,
        ...
        .tilemapOffset = 18,
        .flag = F_PURPLE_ROW,
        .inSelectionFlags = F_PURPLE_ROW | F_PURPLE_EXVEEMON | F_PURPLE_BIOSTEGMON | F_PURPLE_BIRDRAMON | F_PURPLE_BETGAMAMON,
        .flashFlags = F_FLASH_COLOR_P_EXVEEMON | F_FLASH_COLOR_P_BIOSTEGMON | F_FLASH_COLOR_P_BIRDRAMON | F_FLASH_COLOR_P_BETGAMAMON,
    },
    [SQU_PURPLE_EXVEEMON] = {
        .spriteIdOffset = 8,
        .baseMultiplier = NUM_ROULETTE_SLOTS,
        ...
        .var05 = 9,
        .tilemapOffset = 9,
        .flag = F_PURPLE_EXVEEMON,
        .inSelectionFlags = F_PURPLE_EXVEEMON,
        .flashFlags = F_FLASH_ICON | F_FLASH_COLOR_P_EXVEEMON,
    },
    [SQU_PURPLE_BIOSTEGMON] = {
        .spriteIdOffset = 5,
        .baseMultiplier = NUM_ROULETTE_SLOTS,
        .column = 2,
        .row = 3,
    ...
    [SQU_PURPLE_BETGAMAMON] = {
        ...
        .var05 = 9,
        .tilemapOffset = 9,
        .flag = F_PURPLE_BETGAMAMON,
        .inSelectionFlags = F_PURPLE_BETGAMAMON,
        .flashFlags = F_FLASH_ICON | F_FLASH_COLOR_P_BETGAMAMON,
    },
};
...
{
    {
        .id1 = 0,
        .id2 = 1,
        .gridSquare = SQU_ORANGE_EXVEEMON,
        .flag = F_ORANGE_EXVEEMON,
    },
    {
        .id1 = 1,
        .id2 = 3,
        .gridSquare = SQU_GREEN_BIOSTEGMON,
        .flag = F_GREEN_BIOSTEGMON,
    },
    {
        .id1 = 2,
    ...
    },
    {
        .id1 = 3,
        .id2 = 7,
        .gridSquare = SQU_ORANGE_BETGAMAMON,
        .flag = F_ORANGE_BETGAMAMON,
    },
    {
        .id1 = 4,
        .id2 = 9,
        .gridSquare = SQU_GREEN_EXVEEMON,
        .flag = F_GREEN_EXVEEMON,
    },
    {
        .id1 = 5,
        .id2 = 11,
        .gridSquare = SQU_PURPLE_BIOSTEGMON,
        .flag = F_PURPLE_BIOSTEGMON,
    },
    {
        .id1 = 6,
    ...
    },
    {
        .id1 = 7,
        .id2 = 15,
        .gridSquare = SQU_GREEN_BETGAMAMON,
        .flag = F_GREEN_BETGAMAMON,
    },
    {
        .id1 = 8,
        .id2 = 17,
        .gridSquare = SQU_PURPLE_EXVEEMON,
        .flag = F_PURPLE_EXVEEMON,
    },
    {
        .id1 = 9,
        .id2 = 19,
        .gridSquare = SQU_ORANGE_BIOSTEGMON,
        .flag = F_ORANGE_BIOSTEGMON,
    },
    {
        .id1 = 10,
    ...
    },
    {
        .id1 = 11,
        .id2 = 23,
        .gridSquare = SQU_PURPLE_BETGAMAMON,
        .flag = F_PURPLE_BETGAMAMON,
    },
};
...
static void Task_SelectFirstEmptySquare(u8 taskId)
{
    ...
    if (sRoulette->hitFlags & F_ORANGE_ROW)
    {
        ...
        for (i = SQU_GREEN_EXVEEMON; i < SQU_GREEN_BETGAMAMON; i++)
        {
    ...
    else
    {
        ...
        for (i = SQU_ORANGE_EXVEEMON; i <= SQU_ORANGE_BETGAMAMON; i++) // <= is accidental, but it will never get that far
        {
            if (!(sRoulette->hitFlags & sGridSelections[i].flag))
                break;
        }
...
static void ProcessBetGridInput(u8 taskId)
{
     ...
     && (dirPressed))
    {
        ...
        if ((u16)(gTasks[taskId].tSelectionId - 1) < COL_BETGAMAMON && !(sRoulette->hitFlags & sGridSelections[gTasks[taskId].tSelectionId].flag))
        {
...
static u8 RecordHit(u8 taskId, u8 slotId)
{
    ...
    u32 columnFlags[NUM_BOARD_POKES] = {
        F_EXVEEMON_COL | F_ORANGE_EXVEEMON | F_GREEN_EXVEEMON | F_PURPLE_EXVEEMON,
    ...
    u32 rowFlags[NUM_BOARD_COLORS] = {
        F_ORANGE_ROW | F_ORANGE_EXVEEMON | F_ORANGE_BIOSTEGMON | F_ORANGE_BIRDRAMON | F_ORANGE_BETGAMAMON,
        F_GREEN_ROW | F_GREEN_EXVEEMON | F_GREEN_BIOSTEGMON | F_GREEN_BIRDRAMON | F_GREEN_BETGAMAMON,
        F_PURPLE_ROW | F_PURPLE_EXVEEMON | F_PURPLE_BIOSTEGMON | F_PURPLE_BIRDRAMON | F_PURPLE_BETGAMAMON
    };
...
static bool8 IsHitInBetSelection(u8 gridSquare, u8 betSelection)
{
    ...
    if (--gridSquare < NUM_GRID_SELECTIONS)
    {
        ...
        case ROW_GREEN:
        case ROW_PURPLE:
            if (hit >= (betSelection + COL_EXVEEMON)
             && hit <= (betSelection + COL_BETGAMAMON))
                return TRUE;
            break;
        // Individual square
        default:
...
static void FlashSelectionOnWheel(u8 selectionId)
{
    ...
    default:
    {
        ...
        if (selectionId >= COL_EXVEEMON && selectionId <= COL_BETGAMAMON)
        ...
        case COL_EXVEEMON:
            palOffset = gSprites[sRoulette->spriteIds[SPR_WHEEL_ICON_ORANGE_EXVEEMON]].oam.paletteNum * 16;
            break;
        case COL_BIOSTEGMON:
...
static const u16 sExveemon_Pal[] = INCBIN_U16("graphics/roulette/exveemon.gbapal");
...
static const struct SpritePalette sSpritePalettes[] =
{
    ...
    { .data = sExveemon_Pal,      .tag = PALTAG_EXVEEMON },
...
static const union AnimCmd *const sAnim_WheelIcon_OrangeExveemon[] =
{
    &sAnim_WheelIcons[0]
};

static const union AnimCmd *const sAnim_WheelIcon_GreenBiostegmon[] =
{
    &sAnim_WheelIcons[1]
};
...
static const union AnimCmd *const sAnim_WheelIcon_OrangeBetgamamon[] =
{
    &sAnim_WheelIcons[3]
};

static const union AnimCmd *const sAnim_WheelIcon_GreenExveemon[] =
{
    &sAnim_WheelIcons[4]
};

static const union AnimCmd *const sAnim_WheelIcon_PurpleBiostegmon[] =
{
    &sAnim_WheelIcons[5]
};
...
static const union AnimCmd *const sAnim_WheelIcon_GreenBetgamamon[] =
{
    &sAnim_WheelIcons[7]
};

static const union AnimCmd *const sAnim_WheelIcon_PurpleExveemon[] =
{
    &sAnim_WheelIcons[8]
};

static const union AnimCmd *const sAnim_WheelIcon_OrangeBiostegmon[] =
{
    &sAnim_WheelIcons[9]
};
...
static const union AnimCmd *const sAnim_WheelIcon_PurpleBetgamamon[] =
{
    &sAnim_WheelIcons[11]
};
...
static const union AnimCmd *const sAnim_ExveemonHeader[] =
{
    &sAnim_Headers[0]
};

static const union AnimCmd *const sAnim_BiostegmonHeader[] =
{
    &sAnim_Headers[2]
};
...
static const union AnimCmd *const sAnim_BetgamamonHeader[] =
{
    &sAnim_Headers[6]
};
...
static const union AnimCmd *const sAnim_GridIcon_Exveemon[] =
{
    &sAnim_GridIcons[0]
};

static const union AnimCmd *const sAnim_GridIcon_Biostegmon[] =
{
    &sAnim_GridIcons[1]
};
...
static const union AnimCmd *const sAnim_GridIcon_Betgamamon[] =
{
    &sAnim_GridIcons[3]
};
...
static const struct SpriteTemplate sSpriteTemplates_GridIcons[NUM_BOARD_POKES] =
{
    ...
    },
    {
        ...
        .paletteTag = PALTAG_GRID_ICONS,
        .oam = &sOam_GridIcon,
        .anims = sAnim_GridIcon_Biostegmon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_GridSquare
    },
    ...
    },
    {
        ...
        .paletteTag = PALTAG_GRID_ICONS,
        .oam = &sOam_GridIcon,
        .anims = sAnim_GridIcon_Betgamamon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_GridSquare
    }
...
// They go Exveemon -> Biostegmon -> Birdramon -> Betgamamon, and Orange -> Green -> Purple
static const struct SpriteTemplate sSpriteTemplates_WheelIcons[NUM_ROULETTE_SLOTS] =
{
    {
        .tileTag = GFXTAG_WHEEL_ICONS,
        .paletteTag = PALTAG_EXVEEMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_OrangeExveemon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
    ...
    {
        .tileTag = GFXTAG_WHEEL_ICONS,
        .paletteTag = PALTAG_BIOSTEGMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_GreenBiostegmon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_WheelIcon
    },
    ...
    {
        .tileTag = GFXTAG_WHEEL_ICONS,
        .paletteTag = PALTAG_BETGAMAMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_OrangeBetgamamon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_WheelIcon
    },
    {
        ...
        .paletteTag = PALTAG_EXVEEMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_GreenExveemon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_WheelIcon
    },
    {
        ...
        .paletteTag = PALTAG_BIOSTEGMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_PurpleBiostegmon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_WheelIcon
    },
    ...
    },
    {
        ...
        .paletteTag = PALTAG_BETGAMAMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_GreenBetgamamon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_WheelIcon
    },
    {
        ...
        .paletteTag = PALTAG_EXVEEMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_PurpleExveemon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_WheelIcon
    },
    {
        ...
        .paletteTag = PALTAG_BIOSTEGMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_OrangeBiostegmon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_WheelIcon
    },
    ...
    },
    {
        ...
        .paletteTag = PALTAG_BETGAMAMON,
        .oam = &sOam_WheelIcon,
        .anims = sAnim_WheelIcon_PurpleBetgamamon,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCB_WheelIcon
    }
...
static const struct OamData sOam_Allomon_x =
{
    .affineMode = ST_OAM_AFFINE_OFF,
    .objMode = ST_OAM_OBJ_NORMAL,
    .shape = SPRITE_SHAPE(32x32),
...
static const union AnimCmd sAnim_Allomon_x_WingDown_Left[] =
{
    ANIMCMD_FRAME(80, 10),
    ANIMCMD_END
};

static const union AnimCmd sAnim_Allomon_x_WingDown_Right[] =
{
    ANIMCMD_FRAME(80, 10, .hFlip = TRUE),
    ANIMCMD_END
};

static const union AnimCmd sAnim_Allomon_x_FlapSlow_Left[] =
{
    ANIMCMD_FRAME(80, 20),
    ANIMCMD_FRAME(96, 20),
    ANIMCMD_JUMP(0)
...
static const union AnimCmd sAnim_Allomon_x_FlapSlow_Right[] =
{
...
static const union AnimCmd sAnim_Allomon_x_FlapFast_Left[] =
{
    ANIMCMD_FRAME(80, 10),
    ANIMCMD_FRAME(96, 10),
    ANIMCMD_JUMP(0)
...
static const union AnimCmd sAnim_Allomon_x_FlapFast_Right[] =
{
    ANIMCMD_FRAME(80, 10, .hFlip = TRUE),
...
{
    sAnim_Allomon_x_WingDown_Left,   // While gliding in
    sAnim_Allomon_x_WingDown_Right,
    sAnim_Allomon_x_FlapSlow_Left,   // While carrying ball
    sAnim_Allomon_x_FlapSlow_Right,
    sAnim_Allomon_x_FlapFast_Left,   // While flying off
...
static const struct OamData sOam_Allomon_xShadow =
{
...
static const union AffineAnimCmd sAffineAnim_Allomon_xShadow[] =
{
...
static const union AffineAnimCmd *const sAffineAnims_Allomon_xShadow[] =
{
    sAffineAnim_Allomon_xShadow
};
...
static const struct SpriteTemplate sSpriteTemplate_Allomon_xShadow =
{
    .tileTag = GFXTAG_SHADOW,
    .paletteTag = PALTAG_SHADOW,
    .oam = &sOam_Allomon_xShadow,
    .anims = sAnims_UnstickMonShadow,
    .images = NULL,
    .affineAnims = sAffineAnims_Allomon_xShadow,
    .callback = SpriteCB_Allomon_x
};
...
static void SpriteCB_UnstickBall_Allomon_xDrop(struct Sprite *sprite)
{
...
static void SpriteCB_UnstickBall_Allomon_xPickUp(struct Sprite *sprite)
{
    if (sprite->data[2]++ < 45)
    {
        sprite->y2--;
    ...
    else
    {
        ...
        else
        {
            ...
            sprite->animEnded = FALSE;
            sprite->data[2] = 0;
            sprite->callback = SpriteCB_UnstickBall_Allomon_xDrop;
            m4aSongNumStart(SE_BALL_THROW);
        }
    }
}

static void SpriteCB_UnstickBall_Allomon_x(struct Sprite *sprite)
{
    UpdateBallPos(sprite);
    ...
    case 90:
        if (sprite->sStuckOnWheelLeft != TRUE)
        {
            sprite->callback = &SpriteCB_UnstickBall_Allomon_xPickUp;
            sprite->data[2] = 0;
        }
        break;
    case 270:
...
static void SpriteCB_UnstickBall(struct Sprite *sprite)
{
    ...
    case TRUE:
        ...
        sprite->callback = SpriteCB_UnstickBall_Allomon_x;
        break;
    }
}
...
static void CreateAllomon_xSprite(struct Sprite *ball)
{
    u8 i = 0;
    s16 t;
    s16 coords[2][2] = {
    ...
    t = ball->data[7] - 2;
    sRoulette->spriteIds[SPR_CLEAR_MON] = CreateSprite(&sSpriteTemplate_Allomon_x, coords[ball->sStuckOnWheelLeft][0], coords[ball->sStuckOnWheelLeft][1], 50);
    StartSpriteAnim(&gSprites[sRoulette->spriteIds[SPR_CLEAR_MON]], ball->sStuckOnWheelLeft);
    sRoulette->spriteIds[SPR_CLEAR_MON_SHADOW_1] = CreateSprite(&sSpriteTemplate_Allomon_xShadow, coords[ball->sStuckOnWheelLeft][0], coords[ball->sStuckOnWheelLeft][1], 51);
    ...
    ball->data[7] = (t * sRouletteTables[sRoulette->tableId].randDistanceHigh) + (sRouletteTables[sRoulette->tableId].allomon_x.baseDropDelay + 45);
    for (; i < 2; i++)
    {
...
static void SetBallStuck(struct Sprite *sprite)
{
    ...
    for (i = 0; i < 4; i++)
    {
        if (angle < sprite->sBallAngle && sprite->sBallAngle <= angle + 90)
        {
            ...
            sRoulette->useAllomon_x = i % 2;
            break;
        }
        if (i == 3)
        {
            sprite->sStuckOnWheelLeft = TRUE;
            sRoulette->useAllomon_x = TRUE;
            break;
        }
        angle += 90;
    }

    if (sRoulette->useAllomon_x)
    {
        if (sprite->sStuckOnWheelLeft)
    ...
    if (sRoulette->useAllomon_x == TRUE && sRoulette->tableId == 1)
...
static void SpriteCB_Allomon_xShadow_Flash(struct Sprite *sprite)
{
    sprite->invisible ^= 1;
}

static void SpriteCB_Allomon_x_FlyAway(struct Sprite *sprite)
{
    if (sprite->y > -16)
    {
        sprite->y--;
...
static void SpriteCB_Allomon_x_PickUpBall(struct Sprite *sprite)
{
    if (sprite->data[1] >= 0)
    {
        sprite->data[1]--;
    ...
    else
    {
        ...
        else
        {
            ...
            sprite->callback = SpriteCB_Allomon_x_FlyAway;
            gSprites[sprite->sMonShadowSpriteId].affineAnimPaused = FALSE;
        }
    }
}

static void SpriteCB_Allomon_x_FlyIn(struct Sprite *sprite)
{
    ...
    else
    {
        ...
        else
        {
            ...
            sprite->data[1] = 45;
            sprite->callback = SpriteCB_Allomon_x_PickUpBall;
        }
    }
}

static void SpriteCB_Allomon_xShadow_FlyIn(struct Sprite *sprite)
{
    s8 moveDir[2] = {-1, 1};
    ...
    {
        sprite->callback = SpriteCB_Allomon_xShadow_Flash;
    }
}

static void SpriteCB_Allomon_x(struct Sprite *sprite)
{
    if (sRoulette->ball->sStuckOnWheelLeft == FALSE)
    {
        if (sRoulette->ball->sBallAngle == sRouletteTables[sRoulette->tableId].allomon_x.rightStartAngle + 90)
        {
    ...
    {
        if (sRoulette->ball->sBallAngle == sRouletteTables[sRoulette->tableId].allomon_x.leftStartAngle + 270)
        {
    ...
    gSprites[sprite->sMonShadowSpriteId].callback = SpriteCB_Allomon_xShadow_FlyIn;
    gSprites[sprite->sMonSpriteId].callback = SpriteCB_Allomon_x_FlyIn;
    m4aSongNumStart(SE_FALL);
}
