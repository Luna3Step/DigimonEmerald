...
const u8 gText_ExpandedPlaceholder_Gatomon_x[] = _("GATOMONX");
...
const u8 gText_Syakomon_xDollAndPrice[] = _("SYAKOMONX DOLL 1,000 COINS");
...
const u8 gText_Falcomon_06Doll80BP[] = _("FALCOMON06 DOLL{CLEAR_TO 0x5E}80BP");
