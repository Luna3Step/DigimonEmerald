...
{
    // Level 50
    {FRONTIER_MON_SAKUTTOMON,     FRONTIER_MON_GAZIMON_X_1},   // 110 - 199
    {FRONTIER_MON_BLGAOGAMON_1, FRONTIER_MON_TOKOMON_1}, // 162 - 266
    {FRONTIER_MON_BLGAOGAMON_2, FRONTIER_MON_TOKOMON_2}, // 267 - 371
    {FRONTIER_MON_BUKAMON_1,  FRONTIER_MON_BABOONMON_1},  // 372 - 467
    {FRONTIER_MON_BUKAMON_2,  FRONTIER_MON_BABOONMON_2},  // 468 - 563
    {FRONTIER_MON_BUKAMON_3,  FRONTIER_MON_BABOONMON_3},  // 564 - 659
    {FRONTIER_MON_BUKAMON_4,  FRONTIER_MON_BABOONMON_4},  // 660 - 755
    {FRONTIER_MON_BUKAMON_1,  FRONTIER_MONS_HIGH_TIER}, // 372 - 849
    ...
    {FRONTIER_MON_BUKAMON_3, FRONTIER_MON_BABOONMON_3}, // 564 - 659
    {FRONTIER_MON_BUKAMON_4, FRONTIER_MON_BABOONMON_4}, // 660 - 755
    {FRONTIER_MON_BUKAMON_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_BUKAMON_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_BUKAMON_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_BUKAMON_1, NUM_FRONTIER_MONS - 1},  // 372 - 881
};
...
static void GenerateOpponentMons(void)
{
    ...
    while (i != FRONTIER_PARTY_SIZE)
    {
        ...
        // Unown (FRONTIER_MON_LOPMON) is forbidden on opponent Factory teams.
        if (gFacilityTrainerMons[monId].species == SPECIES_LOPMON)
            continue;
