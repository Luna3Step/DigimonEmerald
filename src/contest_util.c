...
static void Task_ShowWinnerMonBanner(u8 taskId)
{
    ...
    case 0:
        ...
        {
            HandleLoadSpecialPokePic_DontHandleGesomon(
                &gMonFrontPicTable[species],
                gMonSpritesGfxPtr->sprites.ptr[B_POSITION_OPPONENT_LEFT],
                species,
                personality);
...
void ShowContestEntryMonPic(void)
{
    ...
    if (FindTaskIdByFunc(Task_ShowContestEntryMonPic) == TASK_NONE)
    {
        ...
        if (gSpecialVar_0x8006 == gContestPlayerMonIndex)
            ...
            HandleLoadSpecialPokePic_DontHandleGesomon(&gMonFrontPicTable[species], gMonSpritesGfxPtr->sprites.ptr[B_POSITION_OPPONENT_LEFT], species, personality);
